                    ...
                    <div class="sidebar-box wow fadeInUp">
                        ...
                        <ul class="popular-posts-list">
                            ...
                            <li>
                                ...
                                <span class="views"><i class="far fa-eye"></i> {{ number_format($popular->view_count) }}</span>
                            </li>
                            @empty
                            <li>No popular posts</li>
                            @endforelse
                        </ul>
                    </div>
                    <!-- Popular Posts End -->
                    ...
                    <div class="col-md-12">
                        <div class="post-pagination wow fadeInUp" data-wow-delay="0.5s">
                            <ul class="pagination">
                                ...
                                @else
                                <li><a href="{{ $posts->previousPageUrl() }}"><i class="fa-solid fa-arrow-left-long"></i></a></li>
                                @endif
                                ...
                                <li><a href="{{ $posts->nextPageUrl() }}"><i class="fa-solid fa-arrow-right-long"></i></a></li>
                                @else
