                    ...
                    <div class="about-us-image">
                        <div class="about-img">
                            <figure class="reveal image-anime">
                                <img src="{{ url('front/images/about-img.jpg') }}" alt="">
                            </figure>
                ...
                <div class="col-lg-6">
                    <!-- About Us Content Start -->
                        ...
                        <!-- Section Title Start -->
                            ...
                            <h3 class="wow fadeInUp">about Dr. Indolia Physiotherapy Clinic</h3>
                            <h2 class="text-anime-style-2" data-cursor="-opaque">Expert <span>Physiotherapy Clinic in Agra</span> for Pain Treatment & Healing.</h2>
                            <p class="wow fadeInUp" data-wow-delay="0.25s">At Dr. Indolia Physiotherapy Clinic, having Multiple branches in Agra, we are committed to helping patients regain strength, mobility, and a pain-free life through advanced physiotherapy care.</p>
                            <p class="wow fadeInUp" data-wow-delay="0.25s">Led by Dr. Jugal Indolia, our clinic focuses on delivering personalized rehabilitation programs designed to meet each patient’s unique condition and recovery goals. Inspired by modern physiotherapy practices, we combine clinical expertise with a patient-centered approach to ensure effective and lasting results.</p>
                        ...
                        <div class="about-us-body">
                            ...
                            <div class="about-list-item wow fadeInUp" data-wow-delay="0.5s">
                                <div class="icon-box">
                                    <img src="{{ url('front/images/icon-about-us-1.svg') }}" alt="">
                                </div>
                            ...
                            <div class="about-list-item wow fadeInUp" data-wow-delay="0.5s">
                                <div class="icon-box">
                                    <img src="{{ url('front/images/icon-about-us-2.svg') }}" alt="">
                                </div>
                                <div class="about-list-content">
                                    <h3>be pro active</h3>
                                </div>
                            ...
                            <div class="about-list-item wow fadeInUp" data-wow-delay="0.75s">
                                <div class="icon-box">
                                    <img src="{{ url('front/images/icon-about-us-3.svg') }}" alt="">
                                </div>
                                <div class="about-list-content">
                            ...
                            <div class="about-list-item wow fadeInUp" data-wow-delay="0.75s">
                                <div class="icon-box">
                                    <img src="{{ url('front/images/icon-about-us-4.svg') }}" alt="">
                                </div>
                                <div class="about-list-content">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="company-counter-item">
                        <!-- Icon Box Start -->
                        <div class="icon-box">
                            <img src="{{ url('front/images/icon-counter-1.svg') }}" alt="">
                        </div>
                        <!-- Icon Box End -->
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="company-counter-item">
                        <!-- Icon Box Start -->
                        <div class="icon-box">
                            <img src="{{ url('front/images/icon-counter-2.svg') }}" alt="">
                        </div>
                        <!-- Icon Box End -->
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="company-counter-item">
                        <!-- Icon Box Start -->
                        <div class="icon-box">
                            <img src="{{ url('front/images/icon-counter-3.svg') }}" alt="">
                        </div>
                        <!-- Icon Box End -->

                        <!-- Company Counter Content Start -->
                        <div class="company-counter-content">
                            <h3><span class="counter">5950</span>+</h3>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="company-counter-item">
                        <!-- Icon Box Start -->
                        <div class="icon-box">
                            <img src="{{ url('front/images/icon-counter-4.svg') }}" alt="">
                        </div>
                        <!-- Icon Box End -->
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="our-mva-item wow fadeInUp">
                        <!-- Icon Box Start -->
                        <div class="icon-box">
                            <img src="{{ url('front/images/icon-our-mission.svg') }}" alt="">
                        </div>
                        <!-- Icon Box End -->
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="our-mva-item wow fadeInUp" data-wow-delay="0.25s">
                        <!-- Icon Box Start -->
                        <div class="icon-box">
                            <img src="{{ url('front/images/icon-our-vision.svg') }}" alt="">
                        </div>
                        <!-- Icon Box End -->
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="our-mva-item wow fadeInUp" data-wow-delay="0.5s">
                        <!-- Icon Box Start -->
                        <div class="icon-box">
                            <img src="{{ url('front/images/icon-our-approch.svg') }}" alt="">
                        </div>
                        <!-- Icon Box End -->
                    ...
                    <div class="quality-treatment-video" data-cursor-text="Play">
                        ...
                        <div class="video-image">
                            <a href="https://www.youtube.com/watch?v=Y-x0efG1seA" class="popup-video">
                                <figure class="image-anime">
                                    <img src="{{ url('front/images/quality-treatment-video-img.jpg') }}" alt="">
                                </figure>
                            </a>
                        </div>
                        <!-- Video Image End -->
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="therapy-process-item wow fadeInUp">
                        ...
                        <div class="icon-box">
                            <figure class="image-anime">
                                <img src="{{ url('front/images/therapy-process-1.jpg') }}" alt="">
                            </figure>
                        </div>
                        <!-- Icon Box End -->
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="therapy-process-item wow fadeInUp" data-wow-delay="0.25s">
                        ...
                        <div class="icon-box">
                            <figure class="image-anime">
                                <img src="{{ url('front/images/therapy-process-2.jpg') }}" alt="">
                            </figure>
                        </div>
                        <!-- Icon Box End -->
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="therapy-process-item wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <div class="icon-box">
                            <figure class="image-anime">
                                <img src="{{ url('front/images/therapy-process-3.jpg') }}" alt="">
                            </figure>
                        </div>
                        <!-- Icon Box End -->
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="therapy-process-item wow fadeInUp" data-wow-delay="0.75s">
                        ...
                        <div class="icon-box">
                            <figure class="image-anime">
                                <img src="{{ url('front/images/therapy-process-4.jpg') }}" alt="">
                            </figure>
                        </div>
                        <!-- Icon Box End -->
                                    ...
                                    <div class="testimonial-item">
                                        ...
                                        <div class="testimonial-body">
                                            <div class="author-image">
                                                <figure class="image-anime">
                                                    <img src="{{ url('front/images/author-1.jpg') }}" alt="">
                                                </figure>
                                            </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        ...
                                        <div class="testimonial-body">
                                            <div class="author-image">
                                                <figure class="image-anime">
                                                    <img src="{{ url('front/images/author-2.jpg') }}" alt="">
                                                </figure>
                                            </div>
                                            <div class="author-content">
                                                <h3>jane smith</h3>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        ...
                                        <div class="testimonial-body">
                                            <div class="author-image">
                                                <figure class="image-anime">
                                                    <img src="{{ url('front/images/author-4.jpg') }}" alt="">
                                                </figure>
                                            </div>
                                            <div class="author-content">
                                                <h3>banson doe</h3>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="team-member-item wow fadeInUp">
                        ...
                        <div class="team-image">
                            <figure class="image-anime">
                                <img src="{{ url('front/images/team-1.jpg') }}" alt="">
                            </figure>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="team-member-item wow fadeInUp" data-wow-delay="0.25s">
                        ...
                        <div class="team-image">
                            <figure class="image-anime">
                                <img src="{{ url('front/images/team-2.jpg') }}" alt="">
                            </figure>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="team-member-item wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <div class="team-image">
                            <figure class="image-anime">
                                <img src="{{ url('front/images/team-3.jpg') }}" alt="">
                            </figure>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="team-member-item wow fadeInUp" data-wow-delay="0.75s">
                        ...
                        <div class="team-image">
                            <figure class="image-anime">
                                <img src="{{ url('front/images/team-4.jpg') }}" alt="">
                            </figure>
