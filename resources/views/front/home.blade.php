            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="hero-image">
                        ...
                        <div class="hero-img">
                            <figure>
                                <img src="{{ url('front/images/hero-img.png') }}" alt="">
                            </figure>
                        </div>
                        <!-- Hero Img End -->
                    ...
                    <div class="gallery-carousel-box">
                        <div class="gallery-scrolling-content">
                            ...
                            <div class="gallery-image">
                                <figure class="image-anime">
                                    <img src="{{ url('front/images/gallery-1.jpg') }}" alt="">
                                </figure>
                            </div>
                            <!-- Image Item End -->
                            ...
                            <div class="gallery-image">
                                <figure class="image-anime">
                                    <img src="{{ url('front/images/gallery-2.jpg') }}" alt="">
                                </figure>
                            </div>
                            <!-- Image Item End -->
                            ...
                            <div class="gallery-image">
                                <figure class="image-anime">
                                    <img src="{{ url('front/images/gallery-3.jpg') }}" alt="">
                                </figure>
                            </div>
                            <!-- Image Item End -->
                            ...
                            <div class="gallery-image">
                                <figure class="image-anime">
                                    <img src="{{ url('front/images/gallery-4.jpg') }}" alt="">
                                </figure>
                            </div>
                            <!-- Image Item End -->
                            ...
                            <div class="gallery-image">
                                <figure class="image-anime">
                                    <img src="{{ url('front/images/gallery-5.jpg') }}" alt="">
                                </figure>
                            </div>
                            <!-- Image Item End -->
                            ...
                            <div class="gallery-image">
                                <figure class="image-anime">
                                    <img src="{{ url('front/images/gallery-6.jpg') }}" alt="">
                                </figure>
                            </div>
                            <!-- Image Item End -->
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp">
                        ...
                        <div class="service-footer">
                            <a href="#" class="service-btn"><img src="{{ url('front/images/arrow-white.svg') }}" alt="">
                            </a>
                        </div>
                        <!-- Service Footer End -->
                    </div>
                    ...
                    <div class="solution-plan-image">
                        <div class="solution-plan-img-1">
                            <figure class="image-anime reveal">
                                <img src="{{ url('front/images/solution-plan-img-1.jpg') }}" alt="">
                            </figure>
                        </div>

                        <div class="solution-plan-img-2">
                            <figure class="image-anime reveal">
                                <img src="{{ url('front/images/solution-plan-img-2.jpg') }}" alt="">
                            </figure>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4">
                                    ...
                                    <div class="solution-counter-item">
                                        <div class="icon-box">
                                            <img src="{{ url('front/images/icon-solution-counter-1.svg') }}" alt="">
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-4">
                                    ...
                                    <div class="solution-counter-item">
                                        <div class="icon-box">
                                            <img src="{{ url('front/images/icon-solution-counter-2.svg') }}" alt="">
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-4">
                                    ...
                                    <div class="solution-counter-item">
                                        <div class="icon-box">
                                            <img src="{{ url('front/images/icon-solution-counter-3.svg') }}" alt="">
                                        </div>
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col-lg-6">
                        ...
                        <div class="why-choose-box-1">
                            ...
                            <div class="why-choose-item wow fadeInUp">
                                <!-- Icon Box Start -->
                                <div class="icon-box">
                                    <img src="{{ url('front/images/icon-why-us-1.svg') }}" alt="">
                                </div>
                                <!-- Icon Box End -->
                            ...
                            <div class="why-choose-item wow fadeInUp" data-wow-delay="0.25s">
                                <!-- Icon Box Start -->
                                <div class="icon-box">
                                    <img src="{{ url('front/images/icon-why-us-2.svg') }}" alt="">
                                </div>
                                <!-- Icon Box End -->
                            ...
                            <div class="why-choose-item wow fadeInUp" data-wow-delay="0.5s">
                                <!-- Icon Box Start -->
                                <div class="icon-box">
                                    <img src="{{ url('front/images/icon-why-us-3.svg') }}" alt="">
                                </div>
                                <!-- Icon Box End -->
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="why-choose-box-2">
                            ...
                            <div class="why-choose-item wow fadeInUp">
                                <!-- Icon Box Start -->
                                <div class="icon-box">
                                    <img src="{{ url('front/images/icon-why-us-4.svg') }}" alt="">
                                </div>
                                <!-- Icon Box End -->
                            ...
                            <div class="why-choose-item wow fadeInUp" data-wow-delay="0.25s">
                                <!-- Icon Box Start -->
                                <div class="icon-box">
                                    <img src="{{ url('front/images/icon-why-us-5.svg') }}" alt="">
                                </div>
                                <!-- Icon Box End -->
                            ...
                            <div class="why-choose-item wow fadeInUp" data-wow-delay="0.5s">
                                <!-- Icon Box Start -->
                                <div class="icon-box">
                                    <img src="{{ url('front/images/icon-why-us-6.svg') }}" alt="">
                                </div>
                                <!-- Icon Box End -->
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="why-choose-image">
                            <img src="{{ url('front/images/why-us-img.png') }}" alt="">
                        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-6">
                    <!-- Need Attention List Start -->
                     <div class="need-attention-list wow fadeInUp">
                        <!-- Icon Box Start -->
                        <div class="icon-box">
                            <img src="{{ url('front/images/icon-need-attention-1.svg') }}" alt="">
                        </div>
                        <!-- Icon Box End -->
                ...
                <div class="col-lg-4 col-md-4 col-6">
                    ...
                    <div class="need-attention-list wow fadeInUp">
                        <!-- Icon Box Start -->
                        <div class="icon-box">
                            <img src="{{ url('front/images/icon-need-attention-2.svg') }}" alt="">
                        </div>
                        <!-- Icon Box End -->
                        ...
                        <div class="post-featured-image" data-cursor-text="View">
                            <figure>
                                <a href="#" class="image-anime">
                                    <img src="{{ url('front/images/post-1.jpg') }}" alt="">
                                </a>
                            </figure>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="blog-item wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="post-featured-image" data-cursor-text="View">
                            <figure>
                                <a href="#" class="image-anime">
                                    <img src="{{ url('front/images/post-2.jpg') }}" alt="">
                                </a>
                            </figure>
                        </div>
                        <!-- Post Featured Image End -->
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="blog-item wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <div class="post-featured-image" data-cursor-text="View">
                            <figure>
                                <a href="#" class="image-anime">
                                    <img src="{{ url('front/images/post-3.jpg') }}" alt="">
                                </a>
                            </figure>
                        </div>
                        <!-- Post Featured Image End -->
