...
<div class="row" id="partial-time" style="display:none;">
    <div class="col-md-6">
        <div class="form-group">
    ...
    <div class="col-md-6">
        <div class="form-group">
            <div class="form-check">
                <input type="checkbox" class="form-check-input" id="is_full_day" name="is_full_day" value="1" {{ old('is_full_day', 1) ? 'checked' : '' }}>
