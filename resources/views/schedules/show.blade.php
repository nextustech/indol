                        ...
                        <div class="card ">
                            <div class="card-body">
                                <div class="row tg">
                                    <div class="col-sm-12">
                                        @php
                                            $branchName = optional($branch)->branchName ?? 'Gauri Physiotherapy Clinic';
                                            $branchPhone = optional($branch)->branchPhone ?? '8559-826-826,8306-826-827';
                                            $branchEmail = optional($branch)->branchEmail ?? 'manojsingh2884@gmail.com';
                                            $branchAddress = optional($branch)->address ?? '';
                                            $branchLogo = optional($branch)->logo ? url($branch->logo) : url('images/logo.png');
                                        @endphp
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <span></span><br>
                                            ...
                                            <div class="col-sm-4 text-right">
                                                <span>PH: {{ $branchPhone }}</span><br>
                                                <strong>E-mail : {{ $branchEmail }}</strong>
                                            </div>
                                        </div>
                                        <div class="row text-right">
                                            <div class="col-sm-4">
                                                <span><img src="{{ $branchLogo }}" alt=""></span><br><br>

                                            </div>
                                            <div class="col-sm-5 text-center">
                                                <h3>{{ $branchName }}</h3>
                                                @if($branchAddress)
                                                    <strong>{{ $branchAddress }}</strong><br>
                                                @endif
...
{{--
                                                <b>Package Amount : Rs.{{ $active->amount }}</b>
                                                <b>Amount/visit : Rs.{{ $active->amount/$visits }}</b> --}}
                                            </div>
                                        </div>
                                                                              <div class="row text-left">
                                            <div class="col-sm-4">
                                                <b>Patient Name : {{ $patient->name }} </b> <br>
                                                <b>Address : {{ $patient->address }}</b>
